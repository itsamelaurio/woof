    ...
    return (
        <div> 
            <div id="favorites">
                ...
                <div id="dog-list">
                {props.favorites.map(dog => <div class="favorite"> <img src="images/delete.png" alt="delete dog" className="delete-dog" onClick={() => deleteFavorite(dog.id, props.favorites)}></img> <img src={dog.url} id={dog.id} /> </div>)}
                </div>
            </div>
